...
void AWeapon::Equip(USceneComponent* Parent, FName SocketName, AActor* NewOwner, APawn* NewInstigator, bool PlaySound)
{
...
{
	if (ActorHasSameTag(OtherActor))
		return;
	FHitResult BoxHit;
	BoxTrace(BoxHit);
	if (BoxHit.GetActor() && !ActorHasSameTag(BoxHit.GetActor()) && !BoxHit.GetActor()->ActorHasTag(TEXT("Dead")))
	{
...
void AWeapon::BoxTrace(FHitResult& BoxHit)
{
	...
	TraceIgnoreActors.AddUnique(BoxHit.GetActor());
}
